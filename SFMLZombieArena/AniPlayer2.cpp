...
void AniPlayer2::Init()
{
	...
	clipInfos.push_back({ "IdleUp","MoveUp",false,Utils::GetNormal({0.f,-1.f}) });
	clipInfos.push_back({ "IdleSide","MoveSide",true,Utils::GetNormal({1.f,-1.f}) });

	clipInfos.push_back({ "IdleSide","MoveSide",false,Utils::GetNormal({-1.f,0.f}) });
	clipInfos.push_back({ "IdleSide","MoveSide",true,Utils::GetNormal({1.f,0.f}) });

	clipInfos.push_back({ "IdleSide","MoveSide",false,Utils::GetNormal({-1.f,1.f}) });
	clipInfos.push_back({ "IdleDown","MoveDown",false,Utils::GetNormal({0.f,1.f}) });
	clipInfos.push_back({ "IdleSide","MoveSide",true,Utils::GetNormal({1.f,1.f}) });
...
void AniPlayer2::Update(float dt)
{
	...
	SetScale({ currentClipInfo->flipX ? -1.f : 1.f,1.f });
